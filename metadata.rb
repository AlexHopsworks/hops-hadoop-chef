...
recipe            "hops::hdfs_certs", "Setup hdfs user certificates"
...
attribute "hops/retry_policy_spec",
          :description => "Retry policy specification. For example '2.5.0,6,60000,10' means retry 6 times with 10 sec delay and then retry 10 times with 1 min delay.",
          :type => "string"
