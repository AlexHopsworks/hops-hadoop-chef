...
if node['install']['enterprise']['install'].casecmp? "true"
  ...
  node.override['hops']['dist_url']    = "https://repo.hops.works/dev/jenkins/alex/hops/hops-3.2.0.5-EE-SNAPSHOT.tgz"
  node.override['hops']['schema_dir']  = "https://repo.hops.works/dev/jenkins/alex/hops/hops-schemas"
  node.override['dal']['download_url'] = "https://repo.hops.works/dev/jenkins/alex/hops/ndb-dal-3.2.0.5-EE-SNAPSHOT-21.04.0.jar"
